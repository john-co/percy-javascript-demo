...
describe('Demo App - Ultrafast', function () {
  ...
  before(async () => {
    ...
    conf.setBatch(new BatchInfo('Demo Batch - Playwright - Ultrafast'));
  ...
  it('Smoke Test', async () => {
    ...
    await eyes.open(driver, 'Demo App - Selenium for JavaScript - Ultrafast', 'Smoke Test - Selenium for JavaScript - Ultrafast', new RectangleSize(800, 600));
