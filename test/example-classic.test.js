...
describe('Demo App - Classic', function () {
  ...
  beforeEach(async () => {
    ...
    // set new batch
    conf.setBatch(new BatchInfo('Demo Batch - Selenium for JavaScript - Classic'));
  ...
  it('Smoke Test', async () => {
    ...
    await eyes.open(driver, 'Demo App - Selenium for JavaScript - Classic', 'Smoke Test - Selenium for JavaScript - Classic', new RectangleSize(800, 600));
