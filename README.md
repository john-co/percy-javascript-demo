# Applitools Tutorial - Selenium for JavaScript

Get started with Applitools Eyes visual testing with these examples of using the [Selenium](https://www.selenium.dev/selenium/docs/api/javascript/index.html) and the [Eyes Selenium SDK](https://www.npmjs.com/package/@applitools/eyes-selenium).

- [Quick Start](#%EF%B8%8F-quick-start)
- [Running Tests Locally](#-running-the-tests-locally)
- [What's Inside](#-whats-inside)
- [Add Applitools Eyes to your Selenium project](#-add-applitools-eyes-to-your-selenium-project)

## ⚡️ Quick Start

Run your first test in just a few minutes by cloning this repository!

1. Click the **Use this template** button at the top of the repository or [click here](https://github.com/applitools/tutorial-selenium-javascript/generate) to create a new repository
...
This repository includes a variety of examples on how you can use Applitools Eyes with your Selenium project.
...
## 👀 Add Applitools Eyes to your Selenium project

Learn more about how to install and integrate the Eyes SDK with our [Selenium tutorial](https://applitools.com/tutorials/selenium-javascript.html)!
...
More about the Eyes Selenium SDK:
